...
% Compute the error between a selected set of spectra and the target spectrum
...
if selectionParams.optType == 0
    ...
    devTotal = (1-selectionParams.stdWeight) * max(devMean) + selectionParams.stdWeight * max(devStd);
